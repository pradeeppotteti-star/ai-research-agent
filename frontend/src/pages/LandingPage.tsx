      ...
      <section className="space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="glass-card p-6 rounded-2xl border border-slate-800">
            <div className="w-10 h-10 rounded-xl bg-brand-500/10 text-brand-400 flex items-center justify-center mb-4 border border-brand-500/20">
              <BookOpen className="w-5 h-5" />
            </div>
            <h3 className="font-bold text-slate-100 text-lg mb-2">1. Multi-Tool Integration</h3>
          ...
          <div className="glass-card p-6 rounded-2xl border border-slate-800">
            ...
            <h3 className="font-bold text-slate-100 text-lg mb-2">2. Citation Verification</h3>
            <p className="text-sm text-slate-400 leading-relaxed">
          ...
          <div className="glass-card p-6 rounded-2xl border border-slate-800">
            ...
            <h3 className="font-bold text-slate-100 text-lg mb-2">3. Multimodal Reasoning</h3>
            <p className="text-sm text-slate-400 leading-relaxed">
          ...
          <div className="glass-card p-6 rounded-2xl border border-slate-800">
            ...
            <h3 className="font-bold text-slate-100 text-lg mb-2">4. Adaptive Workflow</h3>
            <p className="text-sm text-slate-400 leading-relaxed">
          ...
          <div className="glass-card p-6 rounded-2xl border border-slate-800">
            ...
            <h3 className="font-bold text-slate-100 text-lg mb-2">5. Efficient Optimization</h3>
            <p className="text-sm text-slate-400 leading-relaxed">
          ...
          <div className="glass-card p-6 rounded-2xl border border-slate-800">
            ...
            <h3 className="font-bold text-slate-100 text-lg mb-2">6. Personalization</h3>
            <p className="text-sm text-slate-400 leading-relaxed">
          ...
          <div className="glass-card p-6 rounded-2xl border border-slate-800">
            ...
            <h3 className="font-bold text-slate-100 text-lg mb-2">7. Research Gap Detection</h3>
            <p className="text-sm text-slate-400 leading-relaxed">
          ...
          <div className="glass-card p-6 rounded-2xl border border-slate-800">
            ...
            <h3 className="font-bold text-slate-100 text-lg mb-2">8. Literature Surveys</h3>
            <p className="text-sm text-slate-400 leading-relaxed">
